...
exports.seed = (knex) => {
  return knex('transactions').del()
    ...
    .then(() => knex('users').insert([
      { id: 10000, name: 'User #1', mail: 'user1@mail.com', password: '$2a$10$avrBKSuZNaJhXVek03biV.oWrqOL8ezmeeh0XwUg.f5S7c/zadUjW' },
      { id: 10001, name: 'User #2', mail: 'user2@mail.com', password: '$2a$10$avrBKSuZNaJhXVek03biV.oWrqOL8ezmeeh0XwUg.f5S7c/zadUjW' }
    ]))
    ...
    .then(() => knex('transfers').insert([
      { id: 10000, descriptions: 'transfer #1', user_id: 10000, acc_ori_id: 10000, acc_dest_id: 10001, amount: 100, date: new Date() },
